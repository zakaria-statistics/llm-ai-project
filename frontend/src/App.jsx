        ...
        <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-4">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="self-end p-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed rounded-xl transition-colors flex items-center justify-center"
            >
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/10">
            <div className="text-xs text-gray-400">
              Press <kbd className="bg-white/10 px-1 rounded">Ctrl</kbd> + <kbd className="bg-white/10 px-1 rounded">Enter</kbd> to send
            </div>
            <div className="text-xs text-gray-400">
